        ...
        dashboardBody(
            ...
            tabItems(
                ...
                tabItem(
                    tabName = "gift",
                    box(
                        title = "Nutrients by GIFT food group", width = 12, height = 100, status = "primary",
                        solidHeader = TRUE, collapsible = TRUE,
                        fluidRow(
                            column(width = 4, downloadButton("download_gift", "Download", class = "butt1"))
                ...
                tabItem(
                    ...
                    fluidRow(
                        box(
                            title = a("Crop", style = "font-size: 100%;color: white;", href = "FBSGuidelines.pdf##page=60"), width = 12, status = "primary", br(),
