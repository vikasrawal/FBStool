...
return_data_base_livestock <- function(data_to_save){
...
xx[ElementCode %in% unique(data_to_save$ElementCode) & CPCCode %in% unique(subset(classification, classification %in% c("LP","LD","L"))[,CPCCode])
